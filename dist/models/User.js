...
User.init({
  ...
  roleId: _sequelize["default"].INTEGER
}, {
  sequelize: _database.sequelize,
  modelName: 'user',
  timestamps: false
});
User.hasMany(_Student["default"]);

_Student["default"].belongsTo(User);

User.hasMany(_Teacher["default"]);

_Teacher["default"].belongsTo(User);
